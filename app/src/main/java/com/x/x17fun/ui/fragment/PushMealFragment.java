 ...
 */
public class PushMealFragment extends BaseFragment {
    ...
    public static PushMealFragment newInstance(){
        return new PushMealFragment();
    }
    @Override
    ...
    private void pushMeal() {
        ...
        showLoadingPage();
        App.execute(()->{
            final BaseResult fr = App.webService().publishProduct("displayImgs",getFileList(),hashMap);
