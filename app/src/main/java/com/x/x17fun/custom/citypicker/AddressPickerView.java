package com.x.x17fun.custom.citypicker;
...
import com.x.x17fun.entity.YwpAddressBean;
...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private int defaultSelectedColor = Color.parseColor("#FFCC33");
    ...
    // 确定字体可以点击时候的颜色
    private int defaultSureCanClickColor = Color.parseColor("#FFCC33");
    ...
    public static YwpAddressBean mYwpAddressBean = null ; // 总数据
    ...
    private void initData() {
        ...
        try {
            BufferedReader addressJsonStream = new BufferedReader(new InputStreamReader(mContext.getAssets().open("addres.json")));
            String line;
