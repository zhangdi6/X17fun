...
public class RoundTopImg10dp extends AppCompatImageView {
    float width,height;
    private int mRadiusPx;

    public RoundTopImg10dp(Context context) {
        this(context, null);
    }

    public RoundTopImg10dp(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundTopImg10dp(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mRadiusPx = DensityUtil.dp2px(10);
