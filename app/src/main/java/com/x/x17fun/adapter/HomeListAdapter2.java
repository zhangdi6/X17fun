...
public class HomeListAdapter2 extends StackLayout.Adapter {

    public ArrayList<TomorrowEntity.TomorrowPublishedListBean> mList = new ArrayList<>();
    private LatLng lat;

    public HomeListAdapter2(LatLng latLng) {
    ...
    public void onBindViewHolder(StackLayout.ViewHolder holder, int position) {
        ...
        TomorrowEntity.TomorrowPublishedListBean baseEntity = mList.get(position);
    ...
    public void addData(List<TomorrowEntity.TomorrowPublishedListBean> objects) {
        mList.clear();
        mList.addAll(objects);
        notifyDataSetChanged();
    }

    public void addNewData(List<TomorrowEntity.TomorrowPublishedListBean> objects) {
        mList.addAll(objects);
        notifyDataSetChanged();
