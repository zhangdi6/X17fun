...
public class BuyInProManAdapter extends RecyclerView.Adapter {

       public ArrayList<BuyInOrderEntity.PurchaseOrdersBean> mList = new ArrayList<>();

       @NonNull
       @Override
       public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
          View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_buy_in_manage, viewGroup, false);
       ...
       public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
          ...
          ViewHolder holder = (ViewHolder) viewHolder;
           BuyInOrderEntity.PurchaseOrdersBean baseEntity = mList.get(i);
          ...
          holder.price.setText("¥ "+baseEntity.getTotalSaleCost());
          ...
          switch (baseEntity.getOrderStatus()){
              case "0":
                  ...
                  case "1":
                      ...
                      holder.btn_delete.setText("确认收货");
                  break;
                  case "2":
                  ...
                  case "4":
                      ...
                      holder.btn_delete.setText("发表评价");
                  break;
                  case "5":
    ...
    public void addData(List<BuyInOrderEntity.PurchaseOrdersBean> objects) {
        mList.clear();
    ...
    public interface onItemClickListener{
        void onClick(int position ,BuyInOrderEntity.PurchaseOrdersBean bean);
        void onBtnClick(int position);
        void onMoreClick(int position);
        void onCancleClick(int position);
        void onRemarkClick(int position);
        void onCallClick(int position);
        void onDeleteClick(BuyInOrderEntity.PurchaseOrdersBean position);
    }
