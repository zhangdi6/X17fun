...
public class BaseActivity2 extends RxAppCompatActivity {
    ...
    protected BaseFragment2 addFragment(FragmentManager manager, Class<? extends BaseFragment2> aClass, int containerId, Bundle args) {
        ...
        if (fragment == null) {// 没有添加
            try {
                ...
                BaseFragment2 baseFragment = (BaseFragment2) fragment; // 强转成我们base fragment
