...
public class HttpsClient {
    ...
    public String updateUserMsg(String url, Map param, String photoName, File photo) {
        try {
            MultipartBody.Builder mb = new MultipartBody.Builder()
                    .setType(MultipartBody.FORM);
            HashMap<String, Object> hashMap = new HashMap<>();
    ...
    public String updateUserMsg(String url, Map param) {
        try {
            MultipartBody.Builder mb = new MultipartBody.Builder()
                    .setType(MultipartBody.FORM);
            HashMap<String, Object> hashMap = new HashMap<>();
    ...
    public String publishProduct(String url, Map param, String fileType, String fileField1, List<File> file1 ) {
        try {
            MultipartBody.Builder mb = new MultipartBody.Builder()
                    .setType(MultipartBody.FORM);
            /*HashMap<String, Object> hashMap = new HashMap<>();*/
            ...
            if (file1 != null && file1.size()!=0) {
                for (int i = 0; i < file1.size(); i++) {
                    mb.addFormDataPart(fileField1, file1.get(i).getName(),
                            RequestBody.create(MediaType.parse(fileType), file1.get(i)));
                }
    ...
    public String sendImg(String url, Map param, String fileType, String fileField1, File file1 ) {
        try {
            MultipartBody.Builder mb = new MultipartBody.Builder()
                    .setType(MultipartBody.FORM);
            /*HashMap<String, Object> hashMap = new HashMap<>();*/
            ...
            if (file1 != null ) {
                    mb.addFormDataPart(fileField1, file1.getName(),
                            RequestBody.create(MediaType.parse(fileType), file1));
            }
